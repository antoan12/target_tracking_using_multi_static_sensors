...
sen2_pos_x=5000;
sen2_pos_y=-9000;
x=input("how many sensor? including monostatic");
sensors_mat=zeros(2,x);
for i=1:x
    mekom_x=input("sensor pos x?");
    mekom_y=input("sensor pos y?");
    sensors_mat(1,i)=mekom_x;
    sensors_mat(2,i)=mekom_y;
end
...
for i_iter = 1:MC_iter
    ...
    [x_hat1,P] = twoD_EKF(sigma_wx,sigma_wy,sigma_v,M,N,path_true,meas_true,sensor_pos_x,sensor_pos_y); % x_hat1=x_tag_p,P = P_0_p
